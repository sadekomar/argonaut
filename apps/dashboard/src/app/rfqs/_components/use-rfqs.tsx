...
export const useAddRfq = () => {
  ...
  return useMutation({
    mutationFn: (data: AddRfqForm) => createRfq(data),
    mutationKey: ["addRfq"],
    onMutate: async (data) => {
      ...
      const transformedData: Rfq = {
        ...
        serialNumber: 0, // Will be set by server
        referenceNumber: "", // Will be generated by server
        date: new Date(data.date),
        currency: data.currency as Currency,
        rate: 0, // Will be fetched by server
        value: Number(data.value),
        notes: data.notes || null,
        authorId: data.authorId,
        author: {
          id: data.authorId,
          name: "", // Will be fetched by server
        },
        ...
        rfqReceivedAt: data.rfqReceivedAt ? new Date(data.rfqReceivedAt) : null,
        quoteId: null,
        createdAt: new Date(),
        updatedAt: new Date(),
      };
      ...
      queryClient.setQueryData(["rfqs"], (old: GetRfqsResponse | undefined) => {
        ...
        return {
          ...
          total: old.total + 1,
          pageCount: Math.ceil((old.total + 1) / (old.data.length || 1)),
        };
      });

      return { previousRfqs, transformedData };
    },
    onSuccess: () => {
