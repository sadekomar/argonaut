...
import { useGetPeopleMetadata } from "./_components/use-people";
...
export default function PeopleClientPage() {
  const { data: peopleMetadata, isPending: peopleMetadataPending } =
